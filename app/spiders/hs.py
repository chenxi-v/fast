...
class Spider(Spider):
    ...
    def getProxyUrl(self):
        return "http://localhost:8000/api/spider/hs/proxy?url="
    ...
    def detailContent(self, ids):
        ...
        vod = {'vod_name': v["title"], 'type_name': ''.join(v.get('tagTitles',[])),'vod_play_from': v.get('nickName') or "å°çº¢ä¹¦å®æ¹", 'vod_play_url': d}
        result = {"list": [vod]}
        return result
